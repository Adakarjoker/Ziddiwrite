...
\033[1;97m     🏛️🏛️🏛️🏛️|ZIDDI WRITES MR ADAKKAR🏛️🏛️🏛️

\033[1;92m     🏛️ 🏛️🏛️🏛️|Z4_ZIDDI_W4_WRITES🏛️
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.youtube.com/ZiDDiWrites09')

    else:

        print "Wrong Username"

        os.system('xdg-open https://www.facebook.com/ZiDDiWrites09')
...
def pilih_super():
	...
	jalan('                    \033[1;97mZiddi start cloning Wait...')
